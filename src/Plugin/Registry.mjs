 ...
 */
export default class TeqFw_Core_Plugin_Registry {
    constructor() {
        /** @type {Object.<string, TeqFw_Core_Plugin_Scan_Item>} */
        const store = {};

        /**
         * @param {String} packageName
         * @returns {TeqFw_Core_Plugin_Scan_Item|null}
         */
        ...
        /**
         * @param {String} packageName
         * @param {TeqFw_Core_Plugin_Scan_Item} item
         */
