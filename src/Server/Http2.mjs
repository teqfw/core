...
export default class TeqFw_Core_App_Server_Http2 {
    ...
    constructor(spec) {
        ...
        /** @type {TeqFw_Core_App_Server_Http2_Stream} */
        const factHndlStream = spec['TeqFw_Core_App_Server_Http2_Stream$'];   // instance singleton
        ...
        this.init = async function () {
            ...
            /** @type {TeqFw_Core_App_Server_Http2_Stream.handler} */
