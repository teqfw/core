 ...
 */
class TeqFw_Core_Back_Cli_Command_Data {
    /**
 ...
 */
class TeqFw_Core_Back_Cli_Command {

    async create() {
        // this is sample code:
        const result = new TeqFw_Core_Back_Cli_Command_Data();
        result.ns = 'vnd-prj';
        result.name = 'command';
...
export {
    TeqFw_Core_Back_Cli_Command as default,
    TeqFw_Core_Back_Cli_Command_Data as Data,
};
