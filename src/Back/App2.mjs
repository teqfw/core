 ...
 * @namespace TeqFw_Core_Back_App2
 */
// MODULE'S IMPORT
...
// MODULE'S CLASSES
export default class TeqFw_Core_Back_App2 {
    /**
    ...
    constructor(
        ...
        this.run = async function ({path}) {
            ...
            try {
                ...
                // TODO: use container part inside the action
        ...
        this.stop = async function () {
             ...
             * @return {Promise<void>}
             */
            async function stopPlugins(plugins) {
                // MAIN
            ...
            // MAIN
            logger.info('Stopping the teq-plugins...');
            await stopPlugins(_plugins);
            logger.info('The teq-app has been stopped.');
        };
    }
}
