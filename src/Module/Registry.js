...
function TeqFw_Core_App_Module_Registry() {
    ...
    /**
     * Name of the folders with modules in `nodejs` applications.
     *
     * @type {string}
     * @default
     */
    ...
    /**
     * Scan `package.json` files (application's own & inside `node_modules`) and save definitions of the teq-modules
     * in registry.
     *
     * @return {Promise<void>}
     */
                ...
                all.forEach((file_package) => {
                    ...
                    $fs.readFile(file_package, (err, raw_data) => {
                        ...
                        if (package_json.teqfw) {
                            ...
                            _obm.addModule({module: package_name, data: di_data});
